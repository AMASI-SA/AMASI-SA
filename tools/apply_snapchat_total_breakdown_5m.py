...
account_path = Path("backend/integrations_control_center/snapchat_account_hourly_refresh.py")
performance_path = Path("backend/integrations_control_center/snapchat_native_performance_sync.py")
test_path = Path("backend/tests/test_snapchat_account_hourly_refresh_v2.py")

account_module = r'''"""Lightweight Snapchat account totals for the five-minute scheduler.
...
'''
account_path.write_text(account_module, encoding="utf-8")
...
''',
    "performance metadata arguments",
)
performance = replace_once(
    performance,
...
print("SNAPCHAT_TOTAL_BREAKDOWN_5M_PATCH_APPLIED")
