#!/usr/bin/env python3
"""Provision a receive-only Meta WhatsApp binding for Mezan.
...
from customer_intelligence.channel_gateway import (  # noqa: E402
    build_channel_account_key,
)
from customer_intelligence.foundation import (  # noqa: E402
    CHANNELS_COLLECTION,
    ChannelRecord,
)
...
def _scope_token(document: dict[str, Any]) -> str:
    """Hash the relevant current state for a pre-insert concurrency check."""
