...
SHA = 'e82918d130f42b228346b2cbd3d70ff4daf21bf3'
...
STATE = Path('/app/.worktrees/preview-runtime-state-20260919')
SOURCE = STATE / 'source'
CONF = Path('/etc/supervisor/conf.d/supervisord.conf')
OWNER = 'preview-persistent-repair-20260919 root 42ae8e95d975'
...
def prepare():
    ...
    assert output(['git','-C','/app','rev-parse','origin/codex/p01-closure-integration-20260918']) == SHA
