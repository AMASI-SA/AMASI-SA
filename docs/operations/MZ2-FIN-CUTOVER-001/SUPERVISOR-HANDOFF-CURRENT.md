...
> أحدث مرجع للحالة هو قسم «نقطة التحقق SUP-20260922-29» في نهاية هذا الملف. الأقسام السابقة محفوظة كسجل الاستئناف التاريخي؛ لا تنقل حالتها القديمة إلى رؤوس أحدث.
