...
> أحدث مرجع للحالة هو قسم «نقطة التحقق SUP-20260923-30» في نهاية هذا الملف. الأقسام السابقة محفوظة كسجل الاستئناف التاريخي؛ لا تنقل حالتها القديمة إلى رؤوس أحدث.
