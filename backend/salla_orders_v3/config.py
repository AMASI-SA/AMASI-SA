...
PROBE_MAX_RESPONSE_BYTES = 1024 * 1024

DISCOVERY_INITIAL_LOOKBACK_DAYS = 1
DISCOVERY_WINDOW_DAYS = 1
# Salla caches sequential pagination for 15 minutes. Stop one minute early;
# a stored page number is not a provider cursor after this session expires.
PAGINATION_SESSION_SECONDS = 14 * 60
