...
def make_order_engine_router(*args, **kwargs):
    ...
    from mobile_employee_monitoring_workspace_routes import make_mobile_employee_monitoring_workspace_router
    ...
    from supplier_dispatch_order_group_guard import make_supplier_dispatch_order_group_preview_router
    ...
    child_routers = [
        ...
        make_mobile_employee_monitoring_workspace_router(db, current_user),
