...
def test_router_registers_readiness_and_permission_contract_paths():
    ...
    expected = {
        ...
        "/financial-provider-apps/accounting-module/shipping-p02/courier/process-pending",
        "/financial-provider-apps/accounting-module/shipping-p02/store-driver/process-pending",
        "/financial-provider-apps/accounting-module/shipping-p02/store-driver-fee/{assignment_id}/preview",
        "/financial-provider-apps/accounting-module/shipping-p02/store-driver-fee",
