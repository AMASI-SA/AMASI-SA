...
def test_router_registers_readiness_and_permission_contract_paths():
    ...
    expected = {
        ...
        "/financial-provider-apps/accounting-module/shipping-p02/activate",
        ...
        "/financial-provider-apps/accounting-module/inventory-p03/workspace",
        "/financial-provider-apps/accounting-module/inventory-p03/opening-inventory-costs",
        "/financial-provider-apps/accounting-module/inventory-p03/opening-inventory-costs/approve",
        ...
        "/financial-provider-apps/accounting-module/inventory-p03/inventory-consumptions/{event_id}/cogs-preview",
