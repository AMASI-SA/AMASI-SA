...
# ─────────────────────────────────────────────────────────────────────
def test_known_fixed_patterns_registry_has_contact_name_only():
    """User directive: only ONE pattern today — contact_name_blank."""
    assert len(KNOWN_FIXED_PATTERNS) == 1
    p = KNOWN_FIXED_PATTERNS[0]
