...
def make_product_inventory_receipt_router(
    ...
    async def receive_purchase(
        ...
        # The old per-line writer cannot bypass full invoice approval or
        # retroactively receive a historical liability-only invoice.
        raise HTTPException(409, detail={"code": "purchase_full_approval_required",
