...
export default function MezanComponentsProduction() {
  ...
  const visible = useMemo(
    () => filterMezanComponents(components, { query, filter: "all" }),
    [components, query],
  );
