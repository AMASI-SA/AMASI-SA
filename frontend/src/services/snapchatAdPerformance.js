...
function metrics(value = {}) {
    return {
        ...
        view_content: number(value.view_content, { integer: true }),
        add_to_cart: number(value.add_to_cart, { integer: true }),
        start_checkout: number(value.start_checkout, { integer: true }),
        add_billing: number(value.add_billing, { integer: true }),
        paid_reach: number(value.paid_reach, { integer: true }),
        paid_frequency: number(value.paid_frequency),
        reach_frequency_scope: text(value.reach_frequency_scope) || null,
