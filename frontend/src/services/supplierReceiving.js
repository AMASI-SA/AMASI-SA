...
const ERROR_LABELS = {
    ...
    supplier_receiving_piece_stopped_before_invoice: "توقفت إحدى القطع بعد المسح. بقيت الجلسة مفتوحة ولم تُنشأ فاتورة أو مديونية.",
    supplier_receiving_experiment_mode_mismatch: "لا يمكن جمع قطع تجريبية وقطع فعلية في جلسة المورد نفسها.",
    supplier_receiving_experiment_run_missing: "بيانات التجربة غير مكتملة؛ ألغِ الجلسة وأعد إسناد الطلب.",
