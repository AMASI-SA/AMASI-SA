...
describe("UnifiedMarketingEntityTable", () => {
    ...
    test("seven-row viewport pins period totals and starts loading when the first batch fits", async () => {
        ...
        Object.defineProperties(scroll, { scrollHeight: { configurable: true, value: 801 }, clientHeight: { configurable: true, value: 800 } });
        expect(container.querySelector('[data-testid="table-load-more-sentinel"]')).not.toBeNull();
        scroll.scrollTop = 1;
        ...
        expect(container.querySelector('[data-testid="table-load-more-sentinel"]')).toBeNull();
