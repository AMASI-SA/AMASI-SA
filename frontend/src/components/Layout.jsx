...
import { List, MagnifyingGlass, Package, Queue, Cube, Warehouse, Plug, Robot, UsersThree, ChartLineUp, ChatsCircle, ClipboardText, ListChecks } from "@phosphor-icons/react";
...
const V2_LINKS = [
    { to: "/mezan-v2-plan", label: "خطة الاكتمال", Icon: ListChecks },
...
function MezanV2Navigation({ location }) {
    const isV2 = ["/mezan-v2-plan", "/orders-v2", "/fulfillment-v2", "/inventory-receiving-v2", "/products-v2", "/components-v2", "/integrations-v2", "/customer-intelligence", "/ads-manager"].some((prefix) => location.pathname.startsWith(prefix));
    if (!isV2) return null;
    return (
