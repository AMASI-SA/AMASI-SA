...
import { List, MagnifyingGlass, Package, Cube, Warehouse, Robot } from "@phosphor-icons/react";
...
function MezanV2Navigation({ location }) {
    const isV2 = ["/orders-v2", "/products-v2", "/components-v2"].some((prefix) => location.pathname.startsWith(prefix));
    if (!isV2) return null;
    return (
