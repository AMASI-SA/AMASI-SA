...
test("employees own management, salary migration, and fulfillment permissions in Mezan V2 navigation", () => {
...
test("employee overview and permissions have distinct active navigation items", () => {
    ...
    expect(isNavigationItemActive(permissions, employees.items[2])).toBe(true);
